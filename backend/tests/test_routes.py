...
def test_launch_readiness_reports_ready_after_full_qwen_verification(tmp_path: Path, monkeypatch):
    ...
    research_review_path.write_text(
        ...
        "- Use imported profiles, saved blends, provider preflight, and Qwen verification.\n\n"
        "## Launch Requirements From Research\n\n"
        "- Launch requires consented voices, saved blend metadata, provider preflight, and Qwen evidence.\n\n"
        "## Source Links\n\n"
