...
- Imports user-provided voice samples with explicit self or written-permission consent metadata.
...
3. Import at least two clean voice samples where the speaker is you or has given written permission.
